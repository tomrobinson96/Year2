...
public class SyndraelSELECT : MonoBehaviour {
	...
	public void LoadOnClick () {
		...
		string sqlQuery = "SELECT Name, Speed, Health, Stamina " + "FROM Player WHERE ID=2";
	...
	{
		Application.LoadLevel ("TeamDescent Syndrael");
	}
